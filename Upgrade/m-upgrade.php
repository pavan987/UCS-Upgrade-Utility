...
<div class="content">
<h1> Upgrade M-series Firmware </h1>
<h2>( This upgrades M-series Server endpoints of registered testbed using Host Firmware Pack )</h2>
...
$.post("/Upgrade/upgrade-action.php",$("#upgrade").serialize()+'&Image=m', function(data) {
if(data=="\nSuccess\n")
