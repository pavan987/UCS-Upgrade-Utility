...
<div class="content">
<h1> Upgrade B-series Firmware </h1>
<h2>( This upgrades B-series Server endpoints of registered testbed using Host Firmware Pack )</h2>
...
$.post("/Upgrade/upgrade-action.php",$("#upgrade").serialize()+'&Image=b', function(data) {
if(data=="\nSuccess\n")
